# Mobile Apps Domain Directives & Category Framework (v5.1)
...
### A. Calculation & Estimation Tools (Niche Calculators & Estimators)
...
### B. Management & Micro-Productivity Tools (Niche Management Tools & Micro-CRMs)
...
### C. Professional & B2B Field Tools (Professional Field & Office Utilities)
...
### E. Entertainment & Creative Tools
...
### F. Editorial, Educational & Content Curation
...
## 2. Category Rotation & Anti-Fixation Gate

- **CHECK `ideas_log.md`**: Inspect the last 3 mobile app entries.
- **STRICT ROTATION RULE**: If 2 recent entries belong to the same category (e.g., Sensor/Audio apps), **DO NOT propose another sensor app**. You MUST choose a concept from Categories A (Calculation), B (Management), C (Professional Tools), D (Social/Community), E (Entertainment), or F (Editorial).
